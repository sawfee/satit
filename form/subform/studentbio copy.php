        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card profile-card m-b30">
                <div class="card-header">
                    <h4 class="card-title">ข้อมูลส่วนตัว <?php //echo $objResulte['PREFIXID1']?></h4>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="mb-3">
                                ...
                                <input type="text" readonly class="form-control"
                                    value="<?php echo $users['STUDENTNAME'].' ('.$users['STUDENTNAMEENG'].')' ?>"
                                    name="fname">
                        ...
                        <div class="col-sm-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="<?php echo $users['HOSPITAL'] ?>"
                                    name="lname">
                            </div>
                        </div>
                        <div class="col-sm-3">
                ...
                <div class="card-header">
                    <h4 class="card-title">ข้อมูลการศึกษาเดิม <?php //echo $objResulte['PREFIXID1']?></h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-3">
                ...
                <div class="card-header">
                    <h4 class="card-title">ที่อยู่ตามทะเบียนบ้าน <?php //echo $objResulte['PREFIXID1']?></h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="<?php echo @$users['NOADD1'] ?>"
                                    name="stdcode" id="stdcode">
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="<?php echo @$users['MOO1'] ?>"
                                    name="stdcode" id="stdcode">
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="<?php echo @$users['SOI1'] ?>"
                                    name="stdcode" id="stdcode">
                            </div>
                        </div>
                        <div class="col-sm-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="<?php echo @$users['STREET1'] ?>"
                                    name="stdcode" id="stdcode">
                            </div>
                        </div>
                        <div class="col-sm-3">
                        ...
                        <div class="col-sm-3">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" value="<?php echo @$users['ZIPCODE1'] ?>"
                                    name="stdcode" id="stdcode">
                            </div>
                        </div>
                    </div>
                ...
                <div class="card-header">
                    <h4 class="card-title">ที่อยู่ปัจจุบัน <?php //echo $objResulte['PREFIXID1']?></h4>
                </div>
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-3">
