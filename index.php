	...
	<div id="main-wrapper">
			...
			<div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							...
							<span class="nav-text">ฐานข้อมูลหลัก</span>
						</a>
						<ul aria-expanded="false">
							...
							<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">รายงานนักเรียน</a>
								<ul aria-expanded="false">
					...
					<li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
							...
							<span class="nav-text">งานรับสมัตร</span>

						</a>
						<ul aria-expanded="false">
							<li><a href="?page=entrance">ปรับสถานะ</a></li>
							<li><a class="has-arrow" href="javascript:void()" aria-expanded="false">รายงาน</a>
								<ul aria-expanded="false">
									<li><a href="?page=v-ent">รายชื่อผู้สมัคร</a></li>
									<li><a href="email-inbox.php">พิมพ์บัตรเข้าสอบเป็นชุด</a></li>
									<li><a href="email-read.php">บันทึกสถานะรายภาค</a></li>
								</ul>
							</li>
					...
					<li><a href="widget-basic.php" class="ai-icon has-arrow" aria-expanded="false">
        ...
        ***********************************-->
		...
		<?php
			...
			{
				//form
				case "all" : include("form/student-all.php"); break;
				case "profile" : include("form/profile-student.php"); break;
				case "entrance" : include("entrance/ent.php"); break;
